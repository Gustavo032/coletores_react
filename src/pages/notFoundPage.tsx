  ...
  <g id="train">
    ...
    <g id="car-layers">
      ...
      <g id="Text">
        ...
        <a href="./">
            <image href="https://vagas.byintera.com/wp-content/uploads/2021/04/luiza-labs.1616501197-1024x376.png" width={"10rem"} height={"10rem"} transform="translate(490.5 135.994)" className="st8 st10" font-size="24.025"/>
        </a>
      </g>
      <g id="ladders">
        <g id="ladder-f">
